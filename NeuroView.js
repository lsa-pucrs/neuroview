var NeuroView = function(jQuery, elem, datasource, dims, params){
  ...
  this.worker = new Boolean(window.Worker);
...
NeuroView.prototype.init = function(){

  var $nv = this;

  function load(callback){
    $nv.$.getJSON( $nv.datasource, function( voxels ) {
      callback(voxels);
    });
  }

  load(function(voxels){
